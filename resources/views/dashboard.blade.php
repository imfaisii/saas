                        ...
                        <div class="card-header">
                            ...
                            <div class="card-extra">
                                <ul class="card-tab-links mr-3 nav-tabs nav" role="tablist">
                                    ...
                                    <li>
                                        <a href="#tl_revenue-week" data-toggle="tab" id="tl_revenue-week-tab"
                                            role="tab" aria-selected="false">Week</a>
                                    </li>
                                    <li>
                                        <a href="#tl_revenue-month" data-toggle="tab" id="tl_revenue-month-tab"
                                            role="tab" aria-selected="false">Month</a>
                                    </li>
                                    <li>
                                        <a href="#tl_revenue-year" data-toggle="tab" id="tl_revenue-year-tab"
                                            role="tab" aria-selected="true">Year</a>
                                    </li>
                                </ul>
                                <div class="dropdown dropleft">
                                    <a href="#" role="button" id="revenue3" data-toggle="dropdown"
                                ...
                                <ul class="card-tab-links mr-3 nav-tabs nav" role="tablist">
                                    <li>
                                        <a class="active" href="#t_revenue-week" data-toggle="tab"
                                            id="t_revenue-week-tab" role="tab" aria-selected="true">Week</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#t_revenue-year" data-toggle="tab" id="t_revenue-year-tab"
                                        ...
                                        <div class="cashflow-display__single">
                                            ...
                                            <h2 class="cashflow-display__amount">50.8<span
                                                    class="color-danger fs-14 fw-600 mr-10"><i
                                                        class="las la-arrow-down"></i> <strong>12%</strong></span></h2>
                                        </div>
                                        <!-- ends: .cashflow-display__single -->
                                        <div class="cashflow-display__single">
                                            ...
                                            <h2 class="cashflow-display__amount">$28k<span
                                                    class="color-success fs-14 fw-600 mr-10"><i
                                                        class="las la-arrow-up"></i> <strong>15%</strong></span></h2>
                                        </div>
                                        <!-- ends: .cashflow-display__single -->
                                    </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-extra">
                                <ul class="card-tab-links mr-3 nav-tabs nav" role="tablist">
                                    ...
                                    <li>
                                        <a href="#t_selling-week" data-toggle="tab" id="t_selling-week-tab"
                                            role="tab" aria-selected="true">Week</a>
                                    </li>
                                    <li>
                                        <a href="#t_selling-month" data-toggle="tab" id="t_selling-month-tab"
                                            role="tab" aria-selected="true">Month</a>
                                    </li>
                                    <li>
                                        <a href="#t_selling-year" data-toggle="tab" id="t_selling-year-tab"
                                            role="tab" aria-selected="true">Year</a>
                                    </li>
                                </ul>
                                <div class="dropdown dropleft">
                    ...
                    <div class="card border-0">
                        <div class="card-header">
                            ...
                            <div class="card-extra">
                                <ul class="card-tab-links mr-3 nav-tabs nav" role="tablist">
                                    <li>
                                        <a class="active" href="#t_deals-today" data-toggle="tab" id="t_deals-today-tab"
                                            role="tab" aria-selected="true">Today</a>
                                    </li>
                                    <li>
                                        <a href="#t_deals-week" data-toggle="tab" id="t_deals-week-tab" role="tab"
                                            aria-selected="true">Week</a>
                                    </li>
                                    <li>
                                        <a href="#t_deals-month" data-toggle="tab" id="t_deals-month-tab" role="tab"
                                            aria-selected="true">Month</a>
                                    </li>
                                    <li>
                                        <a href="#t_deals-year" data-toggle="tab" id="t_deals-year-tab" role="tab"
                                            aria-selected="true">Year</a>
                                    </li>
                                </ul>
                                <div class="dropdown dropleft">
                                    <a href="#" role="button" id="todo" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <span data-feather="more-horizontal"></span>
                                    </a>
